...
export const English = {
  BUTTONS: {
    ...
    duplicateHashDescription           :'Show all files that are likely identical to each other',
    duplicateHashHint                  :'Identical duplicates',
    duplicateHashMoreInfo              :'These files are identical in size and the three small sections that were checked have identical data',
    duplicateLengthDescription         :'Show all files that are the same duration',
