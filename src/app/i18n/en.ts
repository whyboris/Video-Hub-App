...
export const English = {
  BUTTONS: {
    ...
    magicDescription                   :'Enable the magic search which updates the results as you type. Magic search displays all files that contain the search term and every file inside any folder that contains the search term in its name',
