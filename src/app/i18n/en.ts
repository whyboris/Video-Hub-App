...
export const English = {
  BUTTONS: {
    ...
    fileUnionDescription: 'Toggles the search for filenames containing any of the search words',
    ...
    showFolderInGalleryDescription: 'Shows folder locations in gallery',
    showFolderInGalleryHint: 'Show folders path in gallery',
