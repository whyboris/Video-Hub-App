...
export const Russian = {
  BUTTONS: {
    ...
    showFolderInGalleryDescription: 'Показывает расположение папок в представлении файла', // CHANGE
    showFolderInGalleryHint: 'Показать папки в представлении файла', // CHANGE
