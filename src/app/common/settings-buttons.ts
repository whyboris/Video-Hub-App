...
export const SettingsButtonsGroups: SettingsButtonKey[][] = [
  ...
  [
    ...
    "fontSizeLarger",
    "shuffleGalleryNow",
    "showDuration", // show / hide duration of all videos
    "showResolution", // show / hide duration of resolution of videos
    "showFileSize", // show / hide file size of the videos
    "toggleBitrate", // show / hide bitrate data
    "toggleFps", // show / hide fps data
    "toggleYearData", // show / hide year data of videos
    "toggleStarRating", // show / hide Rating
  ],
  [
...
export type SettingsButtonsType = {
  [key in SettingsButtonKey]: SettingsButton;
};
...
export const SettingsButtons: SettingsButtonsType = {
  ...
  showDuration: {
    description: "SETTINGS.showDuration",
    hidden: true,
    title: "SETTINGS.showDuration",
    toggled: true,
    settingsHeading: "SETTINGS.metaDataVisibility",
    iconName: "icon-disabled-hourglass",
  },
  showFiles: {
  ...
  showFileSize: {
    description: "SETTINGS.showFileSize",
    hidden: false,
    title: "SETTINGS.showFileSize",
    toggled: false,
    iconName: "icon-file-size"
  },
  showFilmstrip: {
  ...
  showResolution: {
    description: "SETTINGS.showResolution",
    hidden: false,
    title: "SETTINGS.showResolution",
    toggled: true,
  ...
  toggleStarRating: {
    description: "SETTINGS.toggleStarRating",
    hidden: false,
    title: "SETTINGS.toggleStarRating",
    toggled: false,
    iconName: "icon-star-disabled"
  },
  toggleYearData: {
    description: "SETTINGS.toggleYearData",
    hidden: false,
    title: "SETTINGS.toggleYearData",
    toggled: false,
    iconName: "icon-disable-calendar"
  },
  toggleBitrate: {
    description: "SETTINGS.toggleBitRate",
    hidden: false,
    title: "SETTINGS.toggleBitRate",
    toggled: false,
    iconName: "icon-bitrate"
  },
  toggleFps: {
    description: "SETTINGS.toggleFps",
    hidden: false,
    title: "SETTINGS.toggleFps",
    toggled: false,
    iconName: "icon-fps"
  },
  yearFilter: {
